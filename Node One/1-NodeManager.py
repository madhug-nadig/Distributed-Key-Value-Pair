...
while True:
	...
	if job_type == 'post':
		...
		make_path(command_array, r'C:\Users\Nadig\Desktop\Big Data Project\Node One\tables\\' + command_array[0])

	elif job_type == 'get':
		command = dataarray[1]
		command_array = command.split()
		print("\nRecived: \nCommand: " + str(command))
		res = search_for(command_array, r'C:\Users\Nadig\Desktop\Big Data Project\Node One\tables\\' + command_array[0])
